...
with (locals || {}) {
var interp;
buf.push('<div class="navigation left"></div><div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"> <hr/><h2> <span>Informations de consommation</span><span data-toggle="tooltip" data-placement="bottom" title="Chaque fois que vous validez une recette dans la partie \'Ma cuisine\', le nombre de recettes par catégorie augmentera ici. Ceci dans le but de choisir vos prochaines recettes en fonction de votre historique ! Passez à la page des choix en cliquant sur les flèches roses !" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><hr/><div class="history"><div id="holder"></div></div></div><div class="swiper-slide"> <hr/><h2> <span>Choix des catégories</span><span data-toggle="tooltip" data-placement="bottom" title="Choisissez les catégories de recettes que vous voulez cuisiner puis passez à l\'étape du choix de la recette en cliquant sur les flèches roses !" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><hr/><div class="tags"><div class="row"><div class="col-xs-offset-4 col-xs-2"><span class="tag"><img src="images/cheap.png" alt="pas cher" class="cheap"/></span></div><div class="col-xs-2"><span class="tag"><img src="images/quick.png" alt="rapide" class="quick"/></span></div></div><div class="row"><div class="col-xs-offset-4 col-xs-2"><span class="tag"><img src="images/organic.png" alt="bio" class="organic"/></span></div><div class="col-xs-2"><span class="tag"><img src="images/light.png" alt="light" class="light"/></span></div></div><div class="row"><div class="col-xs-offset-4 col-xs-2"><span class="tag"><img src="images/vegetarian.png" alt="végétarien" class="vegetarian"/></span></div><div class="col-xs-2"><span class="tag"><img src="images/sugar.png" alt="sucré" class="sugar"/></span></div></div></div><hr/><h2> <span>Choix du prix</span><span data-toggle="tooltip" data-placement="bottom" title="Choisissez le prix maximum par personne pour la recette que vous voulez choisir puis passez à l\'étape du choix de la recette en cliquant sur les flèches roses !" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><hr/><form class="price row"><div class="form-group col-xs-offset-4 col-xs-4"><input id="cart-price" placeholder="Prix" required="required" value="10" name="price" class="form-control"/></div></form></div><div class="swiper-slide carts"><hr/><h2><div class="btn btn-primary order">Créer une liste de courses</div><span data-toggle="tooltip" data-placement="bottom" title="Cliquez sur ce bouton une fois vos choix faits, et ce même si vous n\'avez rien à commander pour que la recette apparaisse dans votre liste de recettes à préparer !" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><div class="row"><div class="choose-recipe col-xs-6"><hr/><h2> <span>Mes recettes à cuisiner</span><span data-toggle="tooltip" data-placement="bottom" title="Choisissez les recettes à cuisiner et leur nombre, s\'il manque un produit, celui-ci s\'affichera dans votre liste de courses ! Et il faut créer une liste de courses même si vous ne manquez de rien. Cela permettra de voir la recette s\'afficher sur la page \'Ma cuisine\'" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><hr/><div class="carts-recipes"></div></div><div class="choose-products col-xs-6"><hr/><h2><span>Mon panier</span><span data-toggle="tooltip" data-placement="bottom" title="Il vous manque un produit ? Il s\'affiche alors ici, il ne vous reste plus qu\'à ajuster la quantité qu\'il vous manque avant de créer votre liste de courses !" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><div class="products"></div></div></div><hr/><h2> <span>Mes listes de courses</span><span data-toggle="tooltip" data-placement="bottom" title="La liste de vos courses à effectuer, la commande sera automatique dans la prochaine version" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></h2><hr/><ul class="carts row"></ul></div></div></div><div class="navigation right"></div>');
}
return buf.join("");
};
});
...
with (locals || {}) {
var interp;
buf.push('<div id="content" class="menu"><div class="header"><div class="menu"><a class="menu"><img src="images/title.png" alt="aliventaire" title="Aliventaire"/></a><h2> <p>Vous ne savez pas quoi cuisiner ce soir ? </p><p>Ali-ventaire va vous aider à choisir !</p><p>Et en plus il va vous permettre de commander ce qu\'il vous manque !</p><p>(cliquez sur les \'?\' pour obtenir de l\'aide)</p></h2></div><div class="shop"><a href="/" class="menu"><img src="images/shop.png" alt="shop" title="Retour au menu" class="menu"/></a><h1>Mes courses</h1><div class="pagination"></div></div><div class="fridge"><a href="/" class="menu"><img src="images/fridge.png" alt="fridge" title="Retour au menu" class="menu"/></a><h1>Mon placard</h1><div class="pagination"></div></div><div class="kitchen"><a href="/" class="menu"><img src="images/kitchen.png" alt="kitchen" title="Retour au menu" class="menu"/></a><h1>Ma cuisine</h1><div class="pagination"></div></div><div class="recipes"><a href="/" class="menu"><img src="images/recipes.png" alt="recipes" title="Retour au menu" class="menu"/></a><h1>Mes recettes</h1><div class="pagination"></div></div></div><div class="page"><div class="menu"><div class="row"><span data-toggle="tooltip" data-placement="bottom" title="Ajouter les produits de mes tickets de caisse à mon placard et valider les recettes prêtes à être cuisinées" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span><a href="/" class="kitchen"><img src="images/kitchen.png" alt="kitchen" title="Ma cuisine" class="kitchen"/></a><a href="/" class="fridge"><img src="images/fridge.png" alt="fridge" title="Mon placard" class="fridge"/></a><span data-toggle="tooltip" data-placement="bottom" title="Ajouter, enlever, modifier les produits de mon placard" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></div><div class="row"><span data-toggle="tooltip" data-placement="bottom" title="Créer mes recettes et leur assigner une catégorie" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span><a href="/" class="recipes"><img src="images/recipes.png" alt="recipes" title="Mes recettes" class="recipes"/></a><a href="/" class="shop"><img src="images/shop.png" alt="shop" title="Mes courses" class="shop"/></a><span data-toggle="tooltip" data-placement="bottom" title="Visualiser les recettes que j\'ai cuisinées par catégorie, choisir les prochaines et commander ce qu\'il manque" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></div></div><div id="shop" class="shop"></div><div id="fridge" class="fridge"></div><div id="kitchen" class="kitchen"></div><div id="recipes" class="recipes"></div></div></div>');
}
return buf.join("");
};
});
...
buf.push('/></span></div><div class="col-xs-8"> </div><div class="name"> <span title="recette cuisinée !" class="delete"><button class="btn btn-success"><span class="glyphicon glyphicon-check"></span></button></span><span>' + escape((interp = name) == null ? '' : interp) + '</span></div><div class="recipe-tags"> ');
// iterate tags
;(function(){
...
with (locals || {}) {
var interp;
buf.push('<ul class="recipes"><li>Pas de recette ? Aller dans la page mes courses pour en choisir une !</li></ul>');
}
return buf.join("");
};
});
