...
with (locals || {}) {
var interp;
buf.push('<div id="content" class="menu"><div class="header"><div class="menu"><a class="menu"><img src="images/title.png" alt="aliventaire" title="Aliventaire"/></a><h2> <p>Vous ne savez pas quoi cuisiner ce soir ? </p><p>Ali-ventaire va vous aider à choisir !</p><p>Et en plus il va vous permettre de commander ce qu\'il vous manque !</p><p>(cliquez sur les \'?\' pour obtenir de l\'aide)</p></h2></div><div class="shop"><a href="/" class="menu"><img src="images/shop.png" alt="shop" title="Retour au menu" class="menu"/></a><h1>Mes courses</h1><div class="pagination"></div></div><div class="fridge"><a href="/" class="menu"><img src="images/fridge.png" alt="fridge" title="Retour au menu" class="menu"/></a><h1>Mon placard</h1><div class="pagination"></div></div><div class="kitchen"><a href="/" class="menu"><img src="images/kitchen.png" alt="kitchen" title="Retour au menu" class="menu"/></a><h1>Ma cuisine</h1><div class="pagination"></div></div><div class="recipes"><a href="/" class="menu"><img src="images/recipes.png" alt="recipes" title="Retour au menu" class="menu"/></a><h1>Mes recettes</h1><div class="pagination"></div></div></div><div class="page"><div class="menu"><div class="row"><span data-toggle="tooltip" data-placement="bottom" title="Visualiser les recettes que j\'ai cuisinées par catégorie, choisir les prochaines et commander ce qu\'il manque" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span><a href="/" class="shop"><img src="images/shop.png" alt="shop" title="Mes courses" class="shop"/></a><a href="/" class="fridge"><img src="images/fridge.png" alt="fridge" title="Mon placard" class="fridge"/></a><span data-toggle="tooltip" data-placement="bottom" title="Ajouter, enlever, modifier les produits de mon placard" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></div><div class="row"><span data-toggle="tooltip" data-placement="bottom" title="Ajouter les produits de mes tickets de caisse à mon placard et voir les recettes prêtes à être cuisinées" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span><a href="/" class="kitchen"><img src="images/kitchen.png" alt="kitchen" title="Ma cuisine" class="kitchen"/></a><a href="/" class="recipes"><img src="images/recipes.png" alt="recipes" title="Mes recettes" class="recipes"/></a><span data-toggle="tooltip" data-placement="bottom" title="Créer mes recettes et leur assigner une catégorie" class="tooltips"><span class="glyphicon glyphicon-question-sign"></span></span></div></div><div id="shop" class="shop"></div><div id="fridge" class="fridge"></div><div id="kitchen" class="kitchen"></div><div id="recipes" class="recipes"></div></div></div>');
}
return buf.join("");
};
});
